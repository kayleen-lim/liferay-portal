...
public abstract class CPFriendlyURLEntryLocalServiceBaseImpl
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return cpFriendlyURLEntryPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return cpFriendlyURLEntryPersistence.create(
	...
	public BasePersistence<CPFriendlyURLEntry> getBasePersistence() {
